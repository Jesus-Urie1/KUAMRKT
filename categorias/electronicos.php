...
<head>
    ...
    <title >KUAMRKT - Electronicos</title>
...
<body>
    ...
    <div class="container-fluid" id="productos">
                ...
                <div class="d-flex justify-content-center">
                    <h1 class="font-weight-bold text-dark mt-4">Electronicos</h1>
                </div>
    ...
    <div class="container-fluid" id="barSearchResults">
        ...
        <div class="col-md-11 border my-sm-3 mx-sm-5">
            <div class="d-flex justify-content-center">
                    <div class="container-fluid padding">
