        ...
        <nav class="navbar navbar-expand-l navbar-dark bg-dark col-md-12">
                ...
                <div class="navbar-brand dropdown">
                    <button class="btn btn-default dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Categorias</button>
                        <div class="dropdown-menu">
                            ...
                            <a class="dropdown-item" href="#">Cereales</a>
                ...
                <div class="md-form mx-6">
                        <form class = "form-inline my-2 my-lg-0">
                            ...
                            <button class = "btn btn-secondary my-2 my-sm-0" type = "submit"> <font style = "vertical-align: heredar;"> <font style = "vertical-align: heredar;"> Buscar </font> </font> </button>
                        </form>
                </div>
                <div>
...
<!--Conectar con descripcion en BDD--->         <button type="button" class="btn btn-secondary" data-container="body" data-toggle="popover" data-placement="top" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus.">
                                ...
                                <div class="col-md-3 mt-2">
                                    <div class="card">
                                        <img class="card-img-top" src="images/Uvas.jpg">
                                        <div class="card-body">
                                            <h4 class="card-title d-flex justify-content-center">Uvas</h4>
                                            <div class="input-group mb-3">
                                                <input class="form-control mx-4 my-sm-0" size="10" type="number" id="artic" name="articulos" min="1" max=""> <!--Añadir maximo segun el inventario--->
                                                    <select class="custom-select">
                                                    <option selected="">Pieza(s)</option>
...
<!--Conectar con descripcion en BDD--->         <button type="button" class="btn btn-secondary" data-container="body" data-toggle="popover" data-placement="top" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus.">
                                ...
                                <div class="col-md-3 mt-2">
                                    <div class="card">
                                        <img class="card-img-top" src="images/Piña.jpg">
                                        <div class="card-body">
                                            <h4 class="card-title d-flex justify-content-center">Piña</h4>
                                            <div class="input-group mb-3">
                                                <input class="form-control mx-4 my-sm-0" size="10" type="number" id="artic" name="articulos" min="1" max=""> <!--Añadir maximo segun el inventario--->
                                                    <select class="custom-select">
                                                    <option selected="">Pieza(s)</option>
...
<!--Conectar con descripcion en BDD--->         <button type="button" class="btn btn-secondary" data-container="body" data-toggle="popover" data-placement="top" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus.">
                                ...
                                <div class="col-md-3 mt-2">
                                    <div class="card">
                                        <img class="card-img-top" src="images/cubrebocas.jpg">
                                        <div class="card-body">
                                            <h4 class="card-title d-flex justify-content-center">Cubre bocas</h4>
                                            <div class="input-group mb-3">
                                                <input class="form-control mx-4 my-sm-0" size="10" type="number" id="artic" name="articulos" min="1" max=""> <!--Añadir maximo segun el inventario--->
                                                    <select class="custom-select">
                                                    <option selected="">Pieza(s)</option>
...
<!--Conectar con descripcion en BDD--->         <button type="button" class="btn btn-secondary" data-container="body" data-toggle="popover" data-placement="top" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus.">
                                ...
                                <div class="col-md-3 mt-2">
                                    <div class="card">
                                        <img class="card-img-top" src="images/jamon.jpg">
                                        <div class="card-body">
                                            <h5 class="card-title d-flex justify-content-center">Jamon Fud 500g</h5>
                                            <div class="input-group mb-3">
                                                <input class="form-control mx-4 my-sm-0" size="10" type="number" id="artic" name="articulos" min="1" max=""> <!--Añadir maximo segun el inventario--->
                                                    <select class="custom-select">
                                                    <option selected="">Pieza(s)</option>
